...
<body>
            <div class="sidebar">
                <ul>
                    ...
                    <li>
                        <a href="AddEmployee.jsp" class="active" ><i class="fa-solid fa-plus"></i><span>Add Employees</span></a>
                    </li>
                    <li>
                        <a href="AddEmployee.jsp" ><i class="fa-solid fa-plus"></i><span>Add Employees</span></a>
                    </li>
                    <li>
                        <a href="AddManager.jsp"><i class="fa-regular fa-square-plus"></i><span>Add Managers</span></a>
                    </li>
                    <li>
                        <a href="AdminDisplayEmployeeServlet" ><i class="fa-solid fa-user"></i><span>Employees</span></a>
                    </li>
                    <li>
                        <a href="Manager.jsp" ><i class="fa-solid fa-user-tie"></i><span>Managers</span></a>
                    </li>
                    <li>
                        <a href="AdminDisplayLeaveServlet"><i class="fa-solid fa-bars-progress"></i><span>Manage Leave</span></a>
                    </li>
                </ul>
            </div>
